...
class Generator:
    ...
    def _render_scad(self, code: str, part: str = "both") -> str:
        ...
        return tpl.render(
            ...
            halign=p.halign,
            valign=p.valign,
            frame_enable=getattr(p, "frame_enable", False),
            frame_out_x=p.frame_inner[0] + 2 * p.frame_width,
            frame_out_y=p.frame_inner[1] + 2 * p.frame_width,
            frame_in_x=p.frame_inner[0],
            frame_in_y=p.frame_inner[1],
            frame_z0=p.frame_z[0],
            frame_z1=p.frame_z[1],
